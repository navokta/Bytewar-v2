            ...
            <div key={index} className="group relative">
              ...
              <div className="relative bg-gray-800/50 backdrop-blur-xl rounded-2xl p-6 border border-white/10 h-full flex flex-col">
                ...
                <Link href="/choose-plan">
                  <button className={`w-full py-3 px-4 bg-gradient-to-r ${tier.color} text-gray-900 font-bold rounded-lg hover:opacity-90 transition-opacity duration-300 transform hover:scale-[1.02]`}>
                    Choose Plan
                  </button>
                </Link>
              </div>
