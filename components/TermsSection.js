            ...
            <div className="relative z-10">
              ...
              <ul className="space-y-4 text-gray-300">
                <li className="flex items-start">
                  ...
                  <span className="ml-3">You retain ownership of your work</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 mt-1">
                    <div className="w-2 h-2 bg-indigo-400 rounded-full"></div>
                  </div>
                  <span className="ml-3">Proper attribution for third-party assets required</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 mt-1">
                    <div className="w-2 h-2 bg-indigo-400 rounded-full"></div>
                  </div>
                  <span className="ml-3">Original work created during hackathon only</span>
                </li>
              </ul>
            </div>
          </div>
