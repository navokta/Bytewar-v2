...
const teamMembers = [
  ...
  },
  {
    ...
    image: "/Gaurav.jpg",
    social: {
      instagram: "https://www.instagram.com/gauravsingh7132?igsh=YnB6dWdxNDB2aXk4" // Changed to Instagram
    }
  },
  {
    name: "Bhumi Singhal",
                ...
                <div className="flex gap-3 mt-auto">
                  {member.social.linkedin ? (
                    ...
                    <a 
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-8 h-8 rounded-full bg-gray-700/50 flex items-center justify-center hover:bg-pink-600/50 hover:scale-110 transition-all duration-300 cursor-pointer group/icon"
                      aria-label={`${member.name}'s Instagram`}
                    >
                      <svg className="w-4 h-4 text-gray-400 group-hover/icon:text-pink-300 transition-colors" fill="currentColor" viewBox="0 0 24 24">
